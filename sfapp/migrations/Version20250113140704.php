 ...
 */
final class Version20250113140704 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conseil_salle (conseil_id INT NOT NULL, salle_id INT NOT NULL, INDEX IDX_197CEA47668A3E03 (conseil_id), INDEX IDX_197CEA47DC304035 (salle_id), PRIMARY KEY(conseil_id, salle_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
